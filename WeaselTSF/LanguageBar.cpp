...
static const DWORD LANGBARITEMSINK_COOKIE = 0x29488888;
...
{
	*pbstrToolTip = SysAllocString(L"按滑鼠左鍵以切換模式，按滑鼠右鍵以開啟功能表\r\nLeft-click to switch modes, right-click to open menu");
